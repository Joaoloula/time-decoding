...
def _read_stimulus(sub, run, path, n_scans, tr, glm=False):
    """ Reads stimulus data """
...
def read_data(subject, n_runs=2, tr=1.5, n_scans=403, glm=False,
    ...
    stimuli = [_read_stimulus(sub, run, path, n_scans, tr, glm)
